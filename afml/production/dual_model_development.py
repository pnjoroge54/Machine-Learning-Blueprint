    ...
    def _create_side_specific_bars(self):
        ...
        logger.info(f"Average bar-level spread: {self.spread_series.mean():.5f}")
    ...
    def _print_summary(self, results: Dict):
        ...
        print(f"LONG CV Score:  {results['combined_metrics']['long_cv_score']:.4f}")
        print(f"SHORT CV Score: {results['combined_metrics']['short_cv_score']:.4f}")
        """
